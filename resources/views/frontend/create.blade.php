                   ...
                   <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="customer_name" id="customer_name" class="form-control rounded-pill">
                            @error('customer_name')
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="customer_email" id="customer_email" class="form-control rounded-pill">
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="customer_mobile" id="customer_mobile" class="form-control rounded-pill">
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="company_name" id="company_name" class="form-control rounded-pill">
                            @error('company_name')
                                <span class="help-block text-danger font-weight-bold">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="invoice_number" id="invoice_number" class="form-control rounded-pill">
                            ...
                            <table class="table" id="invoice_detailes">
                                ...
                                <tfoot>
                                        ...
                                        <td>
                                            <div class="input-group mb-3">
                                                <select name="discount_type" id="discount_type" class="discount_type custom-select">
                                                    <option value="fixed">{{ __('Frontend/frontend.fixed') }}</option>
                                                    <option value="percentage">{{ __('Frontend/frontend.percentage') }}</option>
                                                </select>
                                                <div class="input-group-append">
                                                    <input type="number" step="0.01" name="discount_value" id="discount_value" class="discount_value form-control">
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" step="0.01" name="vat_value" id="vat_value" class="vat_value form-control" readonly="readonly">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="3"></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" step="0.01" name="total_due" id="total_due" class="total_due form-control" readonly="readonly">
                                        </td>
                                    </tr>
                                </tfoot>
