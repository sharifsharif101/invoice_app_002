...
<table class="table card-table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td> 
                <a href="{{ route('invoice.show', $invoice->id) }}">{{$invoice->customer_name}}</a>
            </td>
            ...
            <td>
                ...
                onclick="if(confirm('{{ 'Frontend/frontend.r_u_sure' }}')) { document.getElementById('delete-{{$invoice->id}}').submit(); } else { return false; }"
